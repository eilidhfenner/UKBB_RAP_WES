...
- **Stage 11:** _'11_count_qualifying_variants_per_gene.ipynb'_
    ...
    - Total cost: £35
    - Note that there is also an 11a which is a similar script that was run for new analyses for reviewer response. This looks at at other allele frequency bins. 
...
- **Stage 19:** _'19_combined_analysis.Rmd'_
    ...
    - Total cost: £0.40 
    - Note that there is also a 19a which covers a number of different analysis run in response to reviewers (relevant to scripts 13-19 but all put into one)
