...
```{r}
# Read in 
system('dx download ./Variant_counts/Gene_sets/single_gene/single_gene_tests_HC_PTV_AC5orless_counts.csv')
HC_PTV_single_gene=read.csv('single_gene_tests_HC_PTV_AC5orless_counts.csv')
all_ancs=merge(phen, HC_PTV_single_gene, by.x='eid', by.y='Sample_ID')
EU_ancs=subset(all_ancs, all_ancs$EUR>0.8) 

# Set up gene list 
genes=HC_PTV_single_gene[,-2]
genes=genes[,-1]
...
write.csv(results, 'HC_PTV_EUR_anc_AC5orless_single_gene_burden.csv')
system('dx upload HC_PTV_EUR_anc_AC5orless_single_gene_burden.csv --destination ./Variant_counts/Gene_sets/single_gene/')
```
## REVEL >0.75 missense
```{r}
system('dx download ./Variant_counts/Gene_sets/single_gene/single_gene_tests_REVEL75_Miss_AC5orless_counts.csv')

#Clear big HC_PTV file first
rm(HC_PTV_single_gene)
gc()
...
## REVEL miss + HC_PTVS
```{r}
system('dx download ./Variant_counts/Gene_sets/single_gene/single_gene_tests_HC_PTVplusMiss_AC5orless_counts.csv')
both_single_gene=read.csv('single_gene_tests_HC_PTVplusMiss_AC5orless_counts.csv')
...
write.csv(results, 'HC_PTVs_and_Miss_EUR_anc_AC5orless_single_gene_burden.csv')
system('dx upload HC_PTVs_and_Miss_EUR_anc_AC5orless_single_gene_burden.csv --destination ./Variant_counts/Gene_sets/single_gene/')
```
